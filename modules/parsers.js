 ...
 */
export function parseAccountsCredentials(credentials) {
...
export function getChatGroupId(chat) {
...
export function parseChatUsers(users) {
...
export function parseChatProperties(properties) {
    return {
        routing: {
...
export function parseLastThreadSummary(chatSummary) {
...
export function parseEventsFromLastEventPerType(lastEventsByType) {
...
export function parseThreadProperties(properties) {
    return {
        routing: {
...
export function getPropertyValue(properties, ns, key, def) {
    return properties && properties[ns] && properties[ns][key] !== undefined ? properties[ns][key] : def;
}
export function getNumericPropertyValue(properties, ns, key, def) {
...
export function parseSupervisingAgentsIds(properties) {
...
export function hasPropertyValue(properties, ns, key) {
...
export function parseFilledFormFields(fields) {
    if (!fields) {
        return [];
    }
...
export function parseMyProfile(myProfile) {
    return {
...
export function parseRoutingStatus(routingStatus) {
...
export function parseAvatarUrl(avatarUrl) {
    if (!avatarUrl) {
        return;
    }
    return avatarUrl;
...
export function parseStatistics(statistics) {
    return {
...
export function parseCustomerLastVisit(lastVisit) {
    if (!lastVisit) {
        return;
    }
...
export function parseCustomerSessionFields(fields) {
    const result = [];
...
export function parseDetailsJson(details) {
    const result = [];
...
export function parseSneakPeek(sneakPeek) {
    if (!sneakPeek) {
        return null;
    }
...
export function parseChatTransferredPayload(payload) {
    return {
