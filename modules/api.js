...
import { RTM, Storage, WebAPI } from "./services.js";
import { Listeners, TypedEventEmitter, mergeChats, indexBy, createInjector, getActiveThread, getIncompleteThreadIds } from "./helpers.js";
import { parseChatsSummary, parseLicense, parseMyProfile, parseRoutingStatus, parseChatEvent, parseChat, parseSneakPeek, parseChatTransferredPayload, parseUser, parseQueue } from "./parsers.js";
export const $API = createInjector();
export class API extends TypedEventEmitter {
