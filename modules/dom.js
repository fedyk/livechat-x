...
(function (app) {
    ...
    (function (dom) {
        ...
        dom.DomListener = DomListener;
        function addListener(node, type, handler, useCaptureOrOptions) {
        ...
        dom.EnterNode = EnterNode;
        function createEl(tagName, attrs, child) {
        ...
        dom.getDatum = getDatum;
        /**
         * @example safeHTML`Hello ${userName}`
         */
        function safeHTML(data, ...args) {
            let result = data[0];
