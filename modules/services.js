import { TypedEventEmitter, AbortError, ErrorWithType, Listeners } from "./helpers.js";
...
export class RTM extends TypedEventEmitter {
    constructor(url) {
        super();
        this.handleOpen = () => {
            this.emit("open");
...
export class ChatRouter extends TypedEventEmitter {
    constructor() {
        super();
        this.counter = 0;
